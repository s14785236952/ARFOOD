...
public class SnapAdapterFavorite extends RecyclerView.Adapter<SnapAdapterFavorite.ViewHolder> implements GravitySnapHelper.SnapListener {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.recyclerView.setAdapter(new AdapterFavorite(snap.getGravity() == Gravity.START
